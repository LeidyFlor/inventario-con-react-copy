                ...
                <form className="flex items-center gap-x-10" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="grid grid-cols-dense items-center gap-10 bg-background border-2 border-border-edit-informaion p-8 rounded-xl">
                        <div className="grid grid-cols-2 items-center gap-3">
                            <p className="text-body font-semibold text-text-primary">Placa sena:</p>
                            <Input
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Marca:</p>
                            <Select
                                options={brandName}
                                name="brandName"
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Cuentadante:</p>
                            <Select
                                options={userName}
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Cantidad:</p>
                            <Input
                                type="number"
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Valor unitario:</p>
                            <Input
                                type="number"
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Valor total:</p>
                            <Input
                                type="number"
                            ...
                            <Input
                                ...
                                variant="isEdit"
                            />
                            <p className="text-body font-semibold text-text-primary">Estado:</p>
                            <Select
